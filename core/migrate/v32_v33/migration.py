...
"""
Migration from Blueprint v3.2 to v3.3
"""
...
class Migration(AutoMigration):
    ...
    def find_component_and_update(self, subcomponents: list, config: dict) -> list:
        try:
            ...
            # 捕捉異常並打印完整的錯誤堆疊資訊
            print("Migration from Blueprint v3.2 to v3.3 error: ", e)
